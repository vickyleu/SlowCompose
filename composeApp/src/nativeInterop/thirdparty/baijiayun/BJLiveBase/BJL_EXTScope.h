 ...
 */
#define bjl_onExit \
    __strong bjl_cleanupBlock_t bjl_metamacro_concat(bjl_exitBlock_, __LINE__) __attribute__((cleanup(bjl_executeCleanupBlock), unused)) = ^
 ...
 */
#define bjl_weakify(...) \
    bjl_metamacro_foreach_cxt(bjl_weakify_,, __weak, __VA_ARGS__)
...
#define bjl_unsafeify(...) \
    bjl_metamacro_foreach_cxt(bjl_weakify_,, __unsafe_unretained, __VA_ARGS__)
...
#define bjl_strongify(...) \
    ...
    bjl_metamacro_foreach(bjl_strongify_,, __VA_ARGS__) \
...
#define bjl_weakify_(INDEX, CONTEXT, VAR) \
    CONTEXT __typeof__(VAR) bjl_metamacro_concat(VAR, _weak_) = (VAR);

#define bjl_strongify_(INDEX, VAR) \
    __strong __typeof__(VAR) VAR = bjl_metamacro_concat(VAR, _weak_);
