...
@UnstableApi
public final class MediaCodecUtilImpl {
    ...
    private static final String TAG = "MediaCodecUtilImpl";
    private static final Pattern PROFILE_PATTERN = Pattern.compile("^\\D?(\\d+)$");

    @GuardedBy("MediaCodecUtilImpl.class")
    ...
    public static void warmDecoderInfoCache(String mimeType, boolean secure, boolean tunneling) {
        ...
        } catch (DecoderQueryExceptionImpl e) {
     ...
     * @throws DecoderQueryExceptionImpl If there was an error querying the available decoders.
     */
    @Nullable
    public static MediaCodecInfo getDecryptOnlyDecoderInfo() throws DecoderQueryExceptionImpl {
    ...
    public static MediaCodecInfo getDecoderInfo(String mimeType, boolean secure, boolean tunneling)
            throws DecoderQueryExceptionImpl {
    ...
    public static synchronized List<MediaCodecInfo> getDecoderInfos(
            String mimeType, boolean secure, boolean tunneling) throws DecoderQueryExceptionImpl {
     ...
     */
    public static int maxH264DecodableFrameSize() throws DecoderQueryExceptionImpl {
    ...
    private static ArrayList<MediaCodecInfo> getDecoderInfosInternal(
            CodecKey key, MediaCodecListCompat mediaCodecList) throws DecoderQueryExceptionImpl {
        try {
            ...
            throw new DecoderQueryExceptionImpl(e);
        }
    }

    public static class DecoderQueryExceptionImpl extends Exception {
        private DecoderQueryExceptionImpl(Throwable cause) {
            super(cause);
        }
    }
    ...
    private static final class MediaCodecListCompatV21 implements MediaCodecListCompat {
        ...
        private MediaCodecListCompatV21(boolean includeSecure, boolean includeTunneling) {
            codecKind =
