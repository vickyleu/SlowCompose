package chaintech.videoplayer.ui.slider
...
import chaintech.videoplayer.ui.slider.ui.ActiveTrackColor
import chaintech.videoplayer.ui.slider.ui.InactiveTrackColor
import chaintech.videoplayer.ui.slider.ui.ThumbColor
...
object MaterialSliderDefaults {
    ...
    fun Color.toBrush():SliderBrushColor{
        return SliderBrushColor(this)
    }
    @Composable
    ...
    private fun activeTickSolidColor(color: SliderBrushColor) =
        contentColorFor(color.color).copy(alpha = 1f)
