...
fun CenterControlView(
    ...
    isPause: MutableState<Boolean>, // Flag indicating whether the media is paused
        ...
        Box(
            ...
            Row(
                ...
                if (playerConfig.isPauseResumeEnabled) {
                    AnimatedClickableIcon(
                        painterRes = if (isPause.value) playerConfig.playIconResource else playerConfig.pauseIconResource,
                        imageVector = if (isPause.value) Icons.Filled.PlayArrow else Icons.Filled.Pause,
