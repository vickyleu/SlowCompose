...
fun TopControlView(
    ...
    isMute: MutableState<Boolean>, // Flag indicating whether the audio is muted
    onMuteToggle: (() -> Unit), // Callback for toggling mute/unMute
    showControls: MutableState<Boolean>, // Flag indicating whether controls should be shown
            ...
            AnimatedVisibility(
                ...
                Row(
                    ...
                    if (playerConfig.isMuteControlEnabled) {
                        AnimatedClickableIcon(
                            painterRes = if (isMute.value) playerConfig.unMuteIconResource else playerConfig.muteIconResource,
                            imageVector = if (isMute.value) Icons.AutoMirrored.Filled.VolumeOff else Icons.AutoMirrored.Filled.VolumeUp,
